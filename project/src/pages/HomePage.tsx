...
import { Heart, Shield, Users, Star, ArrowRight, Search, PawPrint, Sparkles } from 'lucide-react';
...
export const HomePage: React.FC = () => {
  ...
  const services = [
    { name: 'Pet Grooming', providers: '200+', icon: Sparkles },
    { name: 'Pet Sitting', providers: '150+', icon: Heart },
    { name: 'Veterinary', providers: '80+', icon: Shield },
